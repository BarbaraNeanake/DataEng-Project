...
def extract_data(**kwargs):
    ...
    try:
        ...
        output_file_path = f'./data/weather_{execution_date}_{task_instance_str}.csv'
...
def transform_data(**kwargs):
    ...
    execution_date = kwargs['execution_date']
    task_instance_str = kwargs['ti'].task_id
    output_file_path = f'./data/transformed_weather_{execution_date}_{task_instance_str}.csv'
