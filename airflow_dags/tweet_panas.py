...
def run_twitter_extract(**kwargs):
    logging.info("Extract tweeter_panas task is starting")
    ...
    keywords = ["Jogja panas", "jogja panas", "Jogja Panas", "jogja Panas", "Jogja sumuk", "jogja sumuk", "Jogja sumuk", "Jogja gerah", "Jogja Gerah", "jogja gerah"]
    max_results = 100
    ...
    try:
        ...
        if tweets:
            ...
            output_file_path = f'/home/WeatherWhispers/Output/twitter_panas_{execution_date}_{task_instance_str}.csv'
...
def run_twitter_transform(**kwargs):
    ...
    execution_date = kwargs['execution_date'].strftime("%Y-%m-%d_%H-%M-%S")
    task_instance_str = kwargs['ti'].task_id
    output_file_path = f'/home/WeatherWhispers/Output/transformed_twitter_panas_{execution_date}_{task_instance_str}.csv'
